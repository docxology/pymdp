...
The script will use the following default configuration:
    - Mode: train (use --evaluate flag for evaluation)
    - Config: configs/mnist_config.json
    - Experiment directory: experiments/mnist
...
try:
    ...
    from rgm.utils.rgm_config_validator import validate_config
    ...
    # Try relative imports for development mode
    from utils.rgm_logging import RGMLogging
    from utils.rgm_config_validator import validate_config
